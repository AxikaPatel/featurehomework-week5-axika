Feature: Bookcatagory
  ...
  Scenario Outline:  I should be able to choose any filter option with specific result
    ...
    Examples:
      ...
      | Sort by | Name: low to high | Sorted product with the price in descending order                 |
      | Sort by | Name: high to low | Sorted product with the price in ascending order                  |
  ...
  Scenario Outline: I should be able to see product display format according display format type as per given
    ...
    Then            I should be able to see product format according display format type as per given picture in srs doucumnet
